...
public class Tcs4g_sa extends SessionActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_tcs4g_sa);
...
//                finish();
    ...
    MyTask myTask;
    ImageButton toXlsx, shareBy, tcs4g, legacy_nw;
    ...
    hometextview.setText(getString(R.string.header_tcs4g_sa,circle_id));
...
//        Build the URL to consume API
    Uri.Builder uri_builder = new Uri.Builder()
        ...
        .appendPath(getString(R.string.url_ssa_tcs4g_sa_down));
...
//      String flts = new exportFaults(this).execute(url).get();
      ...
      if(isExternalStorageWritable()) {
        File filepath = new File(Environment.getExternalStorageDirectory()+"/Download/Tcs_Saturation_Faults.xls");
        try {
...
//                    System.out.println(type);
  ...
  private static class MyTask extends AsyncTask<String, String, String> {
    private final WeakReference<Tcs4g_sa> activityReference;
    private MyTask(Tcs4g_sa context) {
    ...
    protected String doInBackground(String... params) {
      Tcs4g_sa activity = activityReference.get();
      try {
