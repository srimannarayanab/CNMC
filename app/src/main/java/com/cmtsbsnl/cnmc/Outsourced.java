...
public class Outsourced extends SessionActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outsourced);
...
//        Uri Builder
        Uri.Builder uri_builder = new Uri.Builder()
                ...
                .appendPath(getString(R.string.url_circlewise_outsourced_down));
...
//                Bitmap bitmap = takeScreenshot();
    ...
    private void buttonCreateExcel(String url) {
        try {
            String flts = new getOutsourcedWiseFaults(this).execute(url).get();
//            System.out.println(flts);
//            Writing to Data to XLS file
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.createSheet("OutSourcedWise");

            HSSFRow row = sheet.createRow(0);
            row.createCell(0).setCellValue("CricleId");
...
//                    System.out.println(type);
    ...
    private static class MyTask extends AsyncTask<String, String, String> {
        private final WeakReference<Outsourced> activityReference;

        public MyTask(Outsourced context) {
        ...
        protected String doInBackground(String... params) {
            Outsourced activity = activityReference.get();
            try {
        ...
        protected void onPostExecute(String s) {
            ...
            tv1.setText(activity.getString(R.string.header_circle));
            tr1.addView(tv1);
            TextView tv2 = new TextView(activity);
            tv2.setText(activity.getString(R.string.header_outsourced));
            tr1.addView(tv2);
            TextView tv3 = new TextView(activity);
            tv3.setText(activity.getString(R.string.header_bsnl_nonip));
            tr1.addView(tv3);
            TextView tv4 = new TextView(activity);
            tv4.setText(activity.getString(R.string.header_perc));
            tr1.addView(tv4);
            ...
            try {
                ...
                if(activity.circle_id.equals("HR") || activity.circle_id.equals("UW")){
                    ...
                    activity.tv_header.setText(activity.getString(R.string.header_circle_outsourced,activity.circle_id));
...
//                Log.i("Array", obj.toString());
                for(int i=0; i<obj.length(); i++){
                    ...
                    final String circle = cat_data.getString("circle");
                    ...
                    btn.setOnClickListener(v -> {
                        Intent intent = new Intent(activity, SsaWiseOutsourced.class);
    ...
    public static class getOutsourcedWiseFaults extends AsyncTask<String, String, String>{
        private final WeakReference<Outsourced> activityReference1;

        public getOutsourcedWiseFaults(Outsourced context) {
            activityReference1 = new WeakReference<>(context);
        }

        @Override
        protected String doInBackground(String... strings) {
            Outsourced activity = activityReference1.get();
            try {
                JSONObject post_obj = new JSONObject();
                post_obj.put("msisdn", activity.sharedPreferences.getString("msisdn", ""));
