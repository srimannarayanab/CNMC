...
public class SsaLockedSites extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_ssa_locked_sites);
...
//        Uri Builder
    Uri.Builder uri_builder = new Uri.Builder()
        ...
        .appendPath(getString(R.string.url_ssa_comm_locked));

    TextView textView = findViewById(R.id.textView1);
    tl = findViewById(R.id.tbl_lyt);
    Intent intent = getIntent();
    circle_id = intent.getStringExtra("circle_id");
    textView.setText(getString(R.string.name_value_hypen, "CommLocked", circle_id));
...
//                Bitmap bitmap = takeScreenshot();
      ...
      screeShare.saveBitmap(bitmap, "ssa wise Commercially locked site "+Constants.getCurrentTime());
    });
  }

  private void buttonCreateExcel(String url) {
    try {
      String flts = new getLockedSitesSsaWiseFaults(this).execute(url).get();
...
//            Writing to Data to XLS file
      ...
      row.createCell(8).setCellValue("Tcs");
      ...
      int eric=0, alc=0, moto=0, hua =0, nor=0, nok=0, zte=0, tcs=0, cnt=0;
      for(int i=0; i<arr.length(); i++){
        ...
        drow.createCell(8).setCellValue(Integer.parseInt(obj.getString("tcs_cnt")));
        ...
        tcs += Integer.parseInt(obj.getString("tcs_cnt"));
      ...
      trow.createCell(8).setCellValue(tcs);
      trow.createCell(9).setCellValue(cnt);

      if(isExternalStorageWritable()) {
        File filepath = new File(Environment.getExternalStorageDirectory()+"/Download/CommLockedSSA.xls");
        try {
...
//                    System.out.println(type);
  ...
  private static class MyTask extends AsyncTask<String, String, String> {
    private final WeakReference<SsaLockedSites> activityReference;
    ProgressDialog pd;

    private MyTask(SsaLockedSites context) {
    ...
    protected String doInBackground(String... params) {
      SsaLockedSites activity = activityReference.get();
      try {
...
//                Log.i("Array", obj.toString());
        ...
        for(int i=0; i<obj.length(); i++){
          ...
          final String ssa_id = c_obj.getString("ssa_id").equals("TOT") ? "%":c_obj.getString("ssa_id");
          ...
          String tcs = c_obj.getString("tejas_cnt");
          ...
          tot_tcs +=Integer.parseInt(tcs);
          tot_tot +=Integer.parseInt(tot);

          Button btn = new Button(activity);
          String ssa= ssa_id.equals("%")?"TOT":ssa_id;
          btn.setText(ssa);
          tr.addView(btn);
          btn.setOnClickListener(v -> {
            Intent intent1 = new Intent(activity, LockedSitesDetails.class);
            intent1.putExtra("circle_id", activity.circle_id);
            intent1.putExtra("ssa_id", ssa_id);
        ...
        btn_f_2.setText(Integer.toString(tot_eric));
        ...
        btn_f_3.setText(Integer.toString(tot_alca));
        ...
        btn_f_4.setText(Integer.toString(tot_moto));
        ...
        btn_f_5.setText(Integer.toString(tot_hua));
        ...
        btn_f_6.setText(Integer.toString(tot_nor));
        ...
        btn_f_7.setText(Integer.toString(tot_nok));
        ...
        btn_f_8.setText(Integer.toString(tot_zte));
        ...
        btn_f_9.setText(Integer.toString(tot_tcs));
        btn_f_9.setOnClickListener(v -> {
          Intent intent1 = new Intent(activity, LockedSitesDetails.class);
          intent1.putExtra("circle_id", activity.circle_id);
          intent1.putExtra("ssa_id", "%");
          intent1.putExtra("vendor_id","9");
        ...
        tv_f_9.setText(Integer.toString(tot_tot));
        tr_f.addView(tv_f_9);
  ...
  public static class getLockedSitesSsaWiseFaults extends AsyncTask<String, String, String>{
    private final WeakReference<SsaLockedSites> activityReference1;

    public getLockedSitesSsaWiseFaults(SsaLockedSites context) {
      activityReference1 = new WeakReference<>(context);
    }

    @Override
    protected String doInBackground(String... strings) {
      SsaLockedSites activity = activityReference1.get();
      try {
        JSONObject post_obj = new JSONObject();
        post_obj.put("msisdn", activity.sharedPreferences.getString("msisdn",""));
        post_obj.put("circle_id", activity.circle_id);
