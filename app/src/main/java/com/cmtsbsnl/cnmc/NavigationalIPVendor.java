...
public class NavigationalIPVendor extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_navigational_ipvendor);
		setupNavigation();
