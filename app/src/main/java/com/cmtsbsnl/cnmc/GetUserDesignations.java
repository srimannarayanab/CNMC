...
public class GetUserDesignations extends AsyncTask<String, Void, String> {
    public static Context ctx;

    public GetUserDesignations(Context ctx){
        GetUserDesignations.ctx = ctx;
    }

    Uri.Builder uri_builder = new Uri.Builder()
            .scheme("https")
            .authority(Constants.getSecureBaseUrl())
            .appendPath("getUserDesignations");
    @Override
